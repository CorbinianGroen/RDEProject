...
def importwindow(master, widthfactor, heightfactor):
    ...
    ct.CTkLabel(master=ArFrame, text='Ar CV:', font=("Calibri", -18), width=1).grid(row=1, column=1, sticky=tk.W, columnspan=3)
    ct.CTkLabel(master=ArFrame, text='Scantype:', font=("Calibri", -18), width=1).grid(row=2, column=1, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Scan Rate:', font=("Calibri", -18), width=1).grid(row=2, column=3, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Scan:', font=("Calibri", -18), width=1).grid(row=2, column=5, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Sep:', font=("Calibri", -18), width=1).grid(row=2, column=7, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Header:', font=("Calibri", -18), width=1).grid(row=2, column=9, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Decimal:', font=("Calibri", -18), width=1).grid(row=2, column=11, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Skip:', font=("Calibri", -18), width=1).grid(row=2, column=13, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Pot Column:', font=("Calibri", -18), width=1).grid(row=2, column=15, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='', font=("Calibri", -18), width=1).grid(row=2, column=17, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='Cur Column:', font=("Calibri", -18), width=1).grid(row=2, column=19, sticky=tk.W)
    ct.CTkLabel(master=ArFrame, text='', font=("Calibri", -18), width=1).grid(row=2, column=21, sticky=tk.W)

    Scans = ("Single", "Multiple")
    ArScan_var = ct.StringVar()
    ArScan = ct.CTkOptionMenu(master=ArFrame, variable=ArScan_var, values=Scans)
    ArScan.configure(width=90, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'),button_hover_color=('grey80', 'grey20'))
    ...
    ArSep.configure(width=90, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ArDecimal.configure(width=50, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ArV.configure(width=30, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ArV.set(Ar_config[8])
    ...
    ArA.configure(width=30, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ct.CTkLabel(master=COFrame, text='CO CV:', font=("Calibri", -18), width=1).grid(row=1, column=1, sticky=tk.W, columnspan=3)
    ct.CTkLabel(master=COFrame, text='Sep:', font=("Calibri", -18), width=1).grid(row=2, column=1, sticky=tk.W)
    ct.CTkLabel(master=COFrame, text='Header:', font=("Calibri", -18), width=1).grid(row=2, column=3, sticky=tk.W)
    ct.CTkLabel(master=COFrame, text='Decimal:', font=("Calibri", -18), width=1).grid(row=2, column=5, sticky=tk.W)
    ct.CTkLabel(master=COFrame, text='Skip:', font=("Calibri", -18), width=1).grid(row=2, column=7, sticky=tk.W)
    ct.CTkLabel(master=COFrame, text='Pot Column:', font=("Calibri", -18), width=1).grid(row=2, column=9, sticky=tk.W)
    ct.CTkLabel(master=COFrame, text='Cur Column:', font=("Calibri", -18), width=1).grid(row=2, column=11, sticky=tk.W)

    Seperators = (";", "spaces", "tabs")
    COSep_var = ct.StringVar()
    COSep = ct.CTkOptionMenu(master=COFrame, variable=COSep_var, values=Seperators)
    COSep.configure(width=90, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    CODecimal.configure(width=50, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ct.CTkLabel(master=ORRFrame, text='ORR O2 Scan:', font=("Calibri", -18), width=1).grid(row=1, column=1, sticky=tk.W, columnspan=3)
    ct.CTkLabel(master=ORRFrame, text='Scantype:', font=("Calibri", -18), width=1).grid(row=2, column=1, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Scan Rate:', font=("Calibri", -18), width=1).grid(row=2, column=3, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Scan:', font=("Calibri", -18), width=1).grid(row=2, column=5, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Sep:', font=("Calibri", -18), width=1).grid(row=2, column=7, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Header:', font=("Calibri", -18), width=1).grid(row=2, column=9, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Decimal:', font=("Calibri", -18), width=1).grid(row=2, column=11, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Skip:', font=("Calibri", -18), width=1).grid(row=2, column=13, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Pot Column:', font=("Calibri", -18), width=1).grid(row=2, column=15, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Cur Column:', font=("Calibri", -18), width=1).grid(row=2, column=17, sticky=tk.W)
    ...
    ORRScan.configure(width=90, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ORRSep.configure(width=90, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ORRDecimal.configure(width=50, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    # ORR_Ar inputs
    ct.CTkLabel(master=ORRFrame, text='ORR Ar Scan:', font=("Calibri", -18), width=1).grid(row=3, column=1, sticky=tk.W, columnspan=3)
    ct.CTkLabel(master=ORRFrame, text='Scantype:', font=("Calibri", -18), width=1).grid(row=4, column=1, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Scan Rate:', font=("Calibri", -18), width=1).grid(row=4, column=3, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Scan:', font=("Calibri", -18), width=1).grid(row=4, column=5, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Sep:', font=("Calibri", -18), width=1).grid(row=4, column=7, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Header:', font=("Calibri", -18), width=1).grid(row=4, column=9, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Decimal:', font=("Calibri", -18), width=1).grid(row=4, column=11, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Skip:', font=("Calibri", -18), width=1).grid(row=4, column=13, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Pot Column:', font=("Calibri", -18), width=1).grid(row=4, column=15, sticky=tk.W)
    ct.CTkLabel(master=ORRFrame, text='Cur Column:', font=("Calibri", -18), width=1).grid(row=4, column=17, sticky=tk.W)

    Scans = ("LSV", "Single", "Multiple")
    ORRaScan_var = ct.StringVar()
    ORRaScan = ct.CTkOptionMenu(master=ORRFrame, variable=ORRaScan_var, values=Scans)
    ORRaScan.configure(width=90, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ORRaSep.configure(width=90, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    ORRaDecimal.configure(width=50, fg_color=('grey80', 'grey20'), button_color=('grey80', 'grey20'), button_hover_color=('grey80', 'grey20'))
    ...
    SaveButton = ct.CTkButton(master=SaveFrame,text="Save", command=save, font=("Calibri", -18), width= 160, height= 10)
